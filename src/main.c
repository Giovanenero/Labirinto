...
char* ARQUIVOS [] =
{
    "imagem/img/teste0.bmp",
    "imagem/img/teste1.bmp",
    "imagem/img/teste2.bmp",
    "imagem/img/teste3.bmp",
    "imagem/img/teste4.bmp",
    "imagem/img/teste5.bmp",
    "imagem/img/teste6.bmp",
    "imagem/img/teste7.bmp",
    "imagem/img/teste8.bmp",
    "imagem/img/teste9.bmp",
    "imagem/img/teste10.bmp",
    "imagem/img/teste11.bmp",
};

#define N_ARQUIVOS 12
...
int main ()
{
    ...
    out_file = fopen ("imagem/out/out.txt", "w");
    ...
    for (i = 0; i < N_ARQUIVOS; i++)
    {
        ...
        if (SALVA_SAIDA)
        {
            ...
            sprintf (nome_saida, "imagem/out/out%d.bmp", i);
